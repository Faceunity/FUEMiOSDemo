...
- (void)viewDidLoad {
    ...
    [DemoCallManager sharedManager].glView = [[FUOpenGLView alloc] initWithFrame:CGRectMake(0, 0, 80, 80)];
    [self.minVideoView addSubview:[DemoCallManager sharedManager].glView];
}
